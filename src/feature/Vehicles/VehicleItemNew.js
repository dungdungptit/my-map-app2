                    ...
                    >
                        <Paper sx={{ mt: 3, p: 2, flexGrow: 1, maxWidth: 1200 }}>
                            <Box sx={{ width: '100%', mt: 2 }}>
                                ...
                                <TextField id="outlined-basic" label={t("vehicles.form.altitude")} variant="outlined" sx={{ width: '100%', mb: 2, mt: 1 }} value={vehicleItem.altitude} onChange={handleInputChange} name="altitude" />
